...
win=Tk()
win.title('Quiz Online System')
win.state('zoomed')
win.configure(bg="powder blue")
win.resizable(width=False,height=False)

lbl_title=Label(win,text="Python Quiz App",font=('Arial',60,'bold','underline'),bg='powder blue')
lbl_title.pack()
...
register_img=Image.open("images/register.png").resize((150,40))
register_imgtk=ImageTk.PhotoImage(register_img)

reg_img=Image.open("images/newuser.png").resize((260,50))
reg_imgtk=ImageTk.PhotoImage(reg_img)

upd_img=Image.open("images/update.png").resize((150,40))
upd_imgtk=ImageTk.PhotoImage(upd_img)

def login_frame():
    
    frm=Frame(win,highlightbackground='brown',highlightthickness=1)
    ...
    lbl_user=Label(frm,text="Username:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_user.place(relx=.25,rely=.1)
    
    lbl_pass=Label(frm,text="Password:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_pass.place(relx=.25,rely=.2)
    
    lbl_type=Label(frm,text="Type:",fg='black',font=('Arial',20,'bold'),bg='green')
    ...
    reg_btn=Label(frm,image=reg_imgtk,bg='green')
    reg_btn.place(relx=.412,rely=.5)
...
def welcome_adminframe():
    ...
    wel_label=Label(frm,font=('Arial',20),text="Welcome,Admin",bg='green')
...
def set_question_frame():
    ...
    lbl_ques=Label(frm,text="Question:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_ques.place(relx=.25,rely=.1)
    
    lbl_op1=Label(frm,text="Option-1:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_op1.place(relx=.25,rely=.2)
    
    lbl_op2=Label(frm,text="Option-2:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_op2.place(relx=.25,rely=.3)
    
    lbl_op3=Label(frm,text="Option-3:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_op3.place(relx=.25,rely=.4)
    
    lbl_op4=Label(frm,text="Option-4:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_op4.place(relx=.25,rely=.5)
    
    lbl_ans=Label(frm,text="Answer:",fg='black',font=('Arial',20,'bold'),bg='green')
...
def view_ques_frame():
    ...
    qcount_lbl=Label(frm,text=f"Total Questions:{qcount}",font=('Arial',30,'bold'),fg='blue',bg='green')
...
def view_users_frame():
    ...
    total_label=Label(frm,font=('Arial',40,'bold'),text=f"Total Users:{ucount}",bg='green',fg='blue')
...
def view_result_frame():
    ...
    wel_label=Label(frm,font=('Arial',20),text=f"Welcome,{user[0]}",bg='green')
    wel_label.place(relx=0,rely=0)
    ...
    total_label=Label(frm,font=('Arial',40,'bold'),text=f"Total Test Taken:{tcount}",bg='green',fg='blue')
    total_label.place(relx=.3,rely=.1)
    con.close()
...
def change_pass_frame():
    ...
    lbl_ps=Label(frm,text="Password:",fg='black',font=('Arial',20,'bold'),bg='green')
    lbl_ps.place(relx=.2,rely=.1)
    
    lbl_cps=Label(frm,text="Confirm Password:",fg='black',font=('Arial',20,'bold'),bg='green')
    ...
    reg_btn=Label(frm,image=upd_imgtk,bg='green')
    reg_btn.place(relx=.35,rely=.3)
    reg_btn.bind("<Button>",update)
...
def start_test_frame():
    ...
    timer_lbl=Label(frm,font=('Arial',20,'bold'),bg='green',fg='red')
    ...
    l=Label(frm,bg='green',font=('Arial',20,'bold'))
    l.place(relx=.3,rely=.2)
    
    rb1=Radiobutton(frm,bg='green',font=('Arial',15,'bold'))
    rb1.place(relx=.3,rely=.3)
        
    rb2=Radiobutton(frm,bg='green',font=('Arial',15,'bold'))
    rb2.place(relx=.3,rely=.4)
        
    rb3=Radiobutton(frm,bg='green',font=('Arial',15,'bold'))
    rb3.place(relx=.3,rely=.5)
        
    rb4=Radiobutton(frm,bg='green',font=('Arial',15,'bold'))
